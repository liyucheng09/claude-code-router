...
export interface ConfigProvider {
  ...
  /**
   * When true, skip the router server and use env/claudeCodeSettings directly.
   * api_base_url, api_key, models are not required in this mode.
   */
  noServer?: boolean;
  /**
   * Raw environment variables passed to Claude Code when noServer is true.
   * These override any computed env vars (ANTHROPIC_BASE_URL, ANTHROPIC_AUTH_TOKEN, etc.)
   */
  env?: Record<string, string>;
  /**
   * Claude Code settings merged when noServer is true.
   */
